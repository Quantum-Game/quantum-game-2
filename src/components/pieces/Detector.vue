<template>
  <svg id="Layer_1" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" :class="{'active': active}">
    <g v-if="active">
    ...
    <g v-else>
      ...
      <ellipse transform="matrix(0.3827 -0.9239 0.9239 0.3827 11.7583 45.5976)" class="st4" cx="40"
        cy="14" rx="5" ry="5" />
      ...
      <path class="st5"
        d="M12.58,25.19c-0.48-1.81-0.8-3.59-1-5.27C11.21,20.52,11,21.24,11,22C11,23.3,11.62,24.46,12.58,25.19z" />
      <path class="st4"
