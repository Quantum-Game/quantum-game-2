...
export default class HomepageTestimonials extends Vue {
  testimonials: { name: string; institute: string; link: string; text: string }[] = [
    {
      name: 'Scott Aaronson',
      institute: 'University of Texas at Austin',
      link: 'https://www.scottaaronson.com/blog/?p=3597',
      text:
    ...
    },
    {
      ...
      link: 'https://twitter.com/decodoku/status/1287758921654992899',
      text:
