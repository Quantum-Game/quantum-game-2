<template>
  <svg @click="rotate">
    <g :style="calculatedStyle">
        ...
        fill="#5a4278"
      />
      <path v-if="cell.active" d="M29.1 39L16 25H3.1l13.1 14zm5.8 0L21.8 25h-2.6l13.1 14z" fill="red" />
...
export default class Tile extends Vue {
  ...
  get calculatedStyle() {
    ...
    if (this.cell.element !== 'Void') {
      styleObj = {
				transform: `translate(${this.translationX}px, ${this.translationY}px) rotate(-${this.cell.rotation}deg)`
      };
    }
    return styleObj;
	}
