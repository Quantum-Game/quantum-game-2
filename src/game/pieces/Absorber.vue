<template>
	<svg id="Layer_1" x="0px" y="0px" viewBox="0 0 64 64" :class="{'isActive': active}">
		<metadata>
			<sfw  xmlns="&ns_sfw;">
				<slices></slices>
				<sliceSourceBounds  bottomLeftOrigin="true" height="52" width="52" x="6" y="6"></sliceSourceBounds>
			</sfw>
		</metadata>
		<g >
			<path id="Qbackground" class="st0" d="M47.6,6H16.4C10.7,6,6,10.7,6,16.4v31.2C6,53.3,10.7,58,16.4,58h31.2
		...
		<g id="Qoutline">
		<path class="st2" d="M47.6,6C53.3,6,58,10.7,58,16.4v31.2C58,53.3,53.3,58,47.6,58H16.4C10.7,58,6,53.3,6,47.6V16.4
